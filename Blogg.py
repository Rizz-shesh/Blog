import json # sa json file na gikan sa lottie
import streamlit as st 
import requests #ambot unsa na basta iban rasab nis url sa lottie haha
from streamlit_lottie import st_lottie #lottie para animation sheesh
...
with st.container():
    image_side = "https://i.postimg.cc/pdfdJHY3/side.png"
    st.sidebar.image(image_side)

    ok = "https://postimg.cc/tYh9k3PF"
    st.sidebar.image(ok)

    about_me = "https://postimg.cc/K1fxSm0z"
    st.sidebar.image(about_me)

taytol = "https://postimg.cc/RNzBWW8h"
st.image(taytol, caption="-Joriz Brent Rule-")

#eme ra sie para change color sa barline
with open('first.css') as source_des:
    st.markdown(f"<style>{source_des.read()}</style>", unsafe_allow_html=True)
#HEADER ni sja ok.
st.markdown("""<h2 style='text-align: left; color: black; font-size: 1.2em; font-style: bold;'>
...
st.write("""<div style="text-align: justify;">given my background in Senior High School - HUMSS academic track, I knew getting into these competitive majors could be an uphill climb.</div>""", unsafe_allow_html=True)

st.markdown("""<h2 style='text-align: center; color: black; font-size: 1.1em; font-style: italic;'>
...
with st.container():
    ...
    with right_column:
        st.write("""<div style="text-align: justify;">
                Come entrance exam day, I could hardly eat breakfast, riddled with nerves over the technical concepts I struggled to grasp. The intense on the questions on the entrance exam paper, dejectedly convinced I had failed. The week-long wait tormented me. 
...
with st.container():
    ...
    with center_column:
        logo = "https://postimg.cc/2qXYy2RN"
        st.image(logo)
    with right_column:
        st.write("""<div style="text-align: justify;">
...
with st.container():
    ...
    with left_column:
        comlab = "https://postimg.cc/DJ9Kd0wC"
        st.image(comlab)
    with right_column:
        st.write("""<div style="text-align: justify;">
                 ...
                 While I had always enjoyed working with computers, the coding syntax seemed like a foreign language.
                  I labored for hours trying to absorb the logic structures to translate ideas into commands the machine could 
                </div>""", unsafe_allow_html=True)

st.write("""<div style="text-align: justify; margin-bottom: 18px;"> execute. My confidence went down when i received my written midterm exam results - 
...
with st.container():
    ...
    with left_column:
        st.write("""<div style="text-align: justify; font-size: 15px; margin-bottom: 20px">
...
with st.container():
    ...
    with right_column:    
        st.write("""<div style="text-align: justify; font-size: 17px;">
        The night before our code retake, Sandyr, Mike, Kenan, and I began studying for our upcoming hands-on exam. 
        On the retake day, it was so intimidating because the aura
        </div>""", unsafe_allow_html=True)
st.write("""<div style="text-align: justify; font-size: 16.8px;">
        of my classmate seemed so different, 
        but our instructor reassured us that the retake hands-on examination was easy. The timer started, 
